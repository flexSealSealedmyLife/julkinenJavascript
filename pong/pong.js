...
this.reset();
        ...
        drawScore()
    {
        ...
        const CHAR_W = this.CHAR_PIZEL * 4;
        this.players.forEach((player, index) => {
            const chars = player.score.toString().split('');
            const offset = align * (index + 1) - (CHAR_W * chars.length / 2) + this.CHAR_PIZEL / 2;
        ...
        reset() {
            ...
            this.ball.pos.y = this._canvas.width / 2;
            this.ball.pos.x = this._canvas.height / 2;
